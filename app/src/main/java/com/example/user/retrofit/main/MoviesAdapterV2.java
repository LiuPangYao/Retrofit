...
public class MoviesAdapterV2 extends RecyclerView.Adapter<MoviesAdapterV2.MovieViewHolder> {
    ...
    public MoviesAdapterV2(List<Movie> movies, int rowLayout, Context context) {
        this.movies = movies;
    ...
    @Override
    public MoviesAdapterV2.MovieViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
